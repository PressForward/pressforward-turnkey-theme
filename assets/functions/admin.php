...
function pressforward_tk_theme_custom_dashboard_widgets() {
	wp_add_dashboard_widget('pressforward_tk_theme_rss_dashboard_widget', __('Custom RSS Feed (Customize in admin.php)', 'jointswp'), 'pressforward_tk_theme_rss_dashboard_widget');
	/*
