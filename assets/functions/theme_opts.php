...
Kirki::add_field( 'pftk_opts', array(
  ...
  Kirki::add_field( 'b2c1-icon', array(
      'type'        => 'text',
      'settings'    => 'b2c1-icon',
      'label'       => __( 'First Column Icon', 'pressforward_turnkey_theme' ),
      'tooltip'        => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'fa-taxi',
      'priority'    => 10,
  ) );
  Kirki::add_field( 'b2c1-title', array(
      'type'        => 'text',
      'settings'    => 'b2c1-title',
      'label'       => __( 'First Column Title', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter a title for the first column', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'B2-C1 Title',
      'priority'    => 10,
  ...
  Kirki::add_field( 'b2c1-link', array(
    'type'        => 'dropdown-pages',
    'settings'    => 'b2c1-link',
    'label'       => __( 'First Column Title Link', 'pressforward_turnkey_theme' ),
    'section'     => 'block2',
  ...
  Kirki::add_field( 'b2c1-text', array(
      'type'        => 'textarea',
      'settings'    => 'b2c1-text',
      'label'       => __( 'First Column Text', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the text that will appear in the first column of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "textarea" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
...
Kirki::add_field( 'pftk_opts', array(
  ...
  Kirki::add_field( 'b2c2-icon', array(
      'type'        => 'text',
      'settings'    => 'b2c2-icon',
      'label'       => __( 'Second Column Icon', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'fa-taxi',
  ...
  Kirki::add_field( 'b2c2-title', array(
      'type'        => 'text',
      'settings'    => 'b2c2-title',
      'label'       => __( 'Second Column Title', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter a title for the second column of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'B2-C2 Title',
      'priority'    => 10,
  ...
  Kirki::add_field( 'b2c2-link', array(
    'type'        => 'dropdown-pages',
    'settings'    => 'b2c2-link',
    'label'       => __( 'Second Column Title Link', 'pressforward_turnkey_theme' ),
    'section'     => 'block2',
  ...
  Kirki::add_field( 'b2c2-text', array(
      'type'        => 'textarea',
      'settings'    => 'b2c2-text',
      'label'       => __( 'Second Column Text', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the text that will appear in the second column of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "textarea" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
...
Kirki::add_field( 'pftk_opts', array(
  ...
  Kirki::add_field( 'b2c3-icon', array(
      'type'        => 'text',
      'settings'    => 'b2c3-icon',
      'label'       => __( 'Third Column Icon', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'fa-taxi',
  ...
  Kirki::add_field( 'b2c3-title', array(
      'type'        => 'text',
      'settings'    => 'b2c3-title',
      'label'       => __( 'Third Column Title', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter a title for column three of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'B2-C3 Title',
      'priority'    => 10,
  ...
  Kirki::add_field( 'b2c3-link', array(
    'type'        => 'dropdown-pages',
    'settings'    => 'b2c3-link',
    'label'       => __( 'Third Column Title Link', 'pressforward_turnkey_theme' ),
    'section'     => 'block2',
  ...
  Kirki::add_field( 'b2c3-text', array(
      'type'        => 'textarea',
      'settings'    => 'b2c3-text',
      'label'       => __( 'Third Column Text', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the text that will appear in column three of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "textarea" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
...
Kirki::add_field( 'pftk_opts', array(
  ...
  Kirki::add_field( 'b2c4-icon', array(
      'type'        => 'text',
      'settings'    => 'b2c4-icon',
      'label'       => __( 'Fourth Column Icon', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'fa-taxi',
  ...
  Kirki::add_field( 'b2c4-title', array(
      'type'        => 'text',
      'settings'    => 'b2c4-title',
      'label'       => __( 'Fourth Column Title', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the title for the fourth column of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
      'default'     => 'B2-C4 Title',
      'priority'    => 10,
  ...
  Kirki::add_field( 'b2c4-link', array(
    'type'        => 'dropdown-pages',
    'settings'    => 'b2c4-link',
    'label'       => __( 'Fourth Column Title Link', 'pressforward_turnkey_theme' ),
    'section'     => 'block2',
  ...
  Kirki::add_field( 'b2c4-text', array(
      'type'        => 'textarea',
      'settings'    => 'b2c4-text',
      'label'       => __( 'Fourth Column Text', 'pressforward_turnkey_theme' ),
      'tooltip'     => __( 'Enter the text that will appear in the fourth column of block 2', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "textarea" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block2',
...
*********************/
  ...
  Kirki::add_field( 'b3-numrows', array(
    'type'        => 'radio-buttonset',
    'settings'    => 'b3-numrows',
    'label'       => __( 'Number of Rows Block 3', 'pressforward_turnkey_theme' ),
    'section'     => 'block3',
    'tooltip'     => 'Select the number of rows for Block 3',
    'default'     => 'Two',
    'priority'    => 10,
    'choices'     => array(
        'One'   => esc_attr__( 'One', 'pressforward_turnkey_theme' ),
        'Two' => esc_attr__( 'Two', 'pressforward_turnkey_theme' ),
    ),
) );
    /*********************
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r1c1-icon', array(
        ...
        'label'       => __( 'First Row First Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'        => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r1c1-title', array(
        ...
        'label'       => __( 'First Row First Column Title', 'pressforward_turnkey_theme' ),
        'tooltip'        => __( 'Enter a title for the first row of the first column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r1c1-link', array(
      ...
      'label'       => __( 'First Row First Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the first row in the first column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
      'multiple'    => 1,
    ) );
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r1c2-icon', array(
        ...
        'label'       => __( 'First Row Second Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r1c2-title', array(
        ...
        'label'       => __( 'First Row Second Column Title', 'pressforward_turnkey_theme' ),
        'help'        => __( 'Enter a title for the first row of the second column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r1c2-link', array(
      ...
      'label'       => __( 'First Row Second Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the second row of the first column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
      'multiple'    => 1,
    ) );
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r1c3-icon', array(
        ...
        'label'       => __( 'First Row Third Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'        => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r1c3-title', array(
        ...
        'label'       => __( 'First Row Third Column Title', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter a title for the first row of the thrid column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r1c3-link', array(
      ...
      'label'       => __( 'First Row Third Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the first row of the third column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
      'multiple'    => 1,
    ) );
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r2c1-icon', array(
        ...
        'label'       => __( 'Second Row First Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r2c1-title', array(
        ...
        'label'       => __( 'Second Row First Column Title', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter a title for the second row of the first column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r2c1-link', array(
      ...
      'label'       => __( 'Second Row First Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the second row of the first column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r2c2-icon', array(
        ...
        'label'       => __( 'Second Row Second Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r2c2-title', array(
        ...
        'label'       => __( 'Second Row Second Column Title', 'pressforward_turnkey_theme' ),
        'tooltip'        => __( 'Enter a title for the second row of the second column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r2c2-link', array(
      ...
      'label'       => __( 'Second Row Second Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the second row of the second column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
      'multiple'    => 1,
    ) );
    ...
    *********************/
    ...
    Kirki::add_field( 'b3r2c3-icon', array(
        ...
        'label'       => __( 'Second Row Third Column Icon', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter the Font Awesome icon name. i.e. fa-camera-retro', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
        'default'     => 'fa-book',
    ...
    Kirki::add_field( 'b3r2c3-title', array(
        ...
        'label'       => __( 'Second Row Third Column Title', 'pressforward_turnkey_theme' ),
        'tooltip'     => __( 'Enter a title for the second row of the third column', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block3',
    ...
    Kirki::add_field( 'b3r2c3-link', array(
      ...
      'label'       => __( 'Second Row Third Column Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block3',
      'tooltip'     => __( 'Select a link for the second row of the third column', 'pressforward_turnkey_theme' ),
      'default'     => '#',
      'priority'    => 10,
      'multiple'    => 1,
    ) );
...
*********************/
  ...
  Kirki::add_field( 'b4-title', array(
      'type'        => 'text',
      'settings'    => 'b4-title',
      'label'       => __( 'Block 4 Title', 'pressforward_turnkey_theme' ),
      'tooltip'        => __( 'Enter a title for Block 4', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block4',
  ...
  Kirki::add_field( 'b4-title-link', array(
    ...
    'label'       => __( 'Block 4 Title Link', 'pressforward_turnkey_theme' ),
    'section'     => 'block4',
  ...
  Kirki::add_field( 'b4-text', array(
      'type'        => 'textarea',
      'settings'    => 'b4-text',
      'label'       => __( 'Block 4 Text', 'pressforward_turnkey_theme' ),
      'tooltip'        => __( 'Enter the text that you want to appear in Block 4', 'pressforward_turnkey_theme' ),
      'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
      'section'     => 'block4',
...
*********************/
    ...
    Kirki::add_field( 'b5-title', array(
        'type'        => 'text',
        'settings'    => 'b5-title',
        'label'       => __( 'Block 5 Title', 'pressforward_turnkey_theme' ),
        'tooltip'        => __( 'Enter a title for Block 5', 'pressforward_turnkey_theme' ),
        'default'     => __( 'This text is entered in the "text" control.', 'pressforward_turnkey_theme' ),
        'section'     => 'block5',
    ...
    Kirki::add_field( 'b5-title-link', array(
      ...
      'label'       => __( 'Block 5 Title Link', 'pressforward_turnkey_theme' ),
      'section'     => 'block5',
